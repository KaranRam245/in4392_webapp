...
example_output = pd.DataFrame(
    {"Text": ["lkjsdlkasjdklajldaskjdal"], "Toxic": [1], "Severe_Toxic": [0], "Obscene": [1],
     "Insult": [1], "Threat": [0], "Identity_Hate": [0]})
...
if task:
    ...
    st.markdown(f'<p>{toxic}{severe_toxic}{obscene}{threat}{insult}{identity_hate}</p>',
